...
const createReservation = async (reservation) => {
    ...
    try {
        ...
        const idNewUser = await createUser(reservation)
        await db.query('INSERT INTO reservation (date_arrivee, date_depart, id_logement, id_utilisateur) VALUES ($1,$2,$3, $4)', [dateArrivee, dateDepart, idLogement, idNewUser]);
