...
function effectuerReservation(mesLogements) {
    ...
    const dateArrivee = readlineSync.question('\nRenseignez votre date d\'arrivée au format AAAA-MM-JJ : \n');
    const dateDepart = readlineSync.question('\nRenseignez votre date de départ au format AAAA-MM-JJ : \n');
...
function rechercheParDate(mesLogements) {
    ...
    const choixArrivee = new Date(readlineSync.question('\nRenseignez une date d\'arrivée au format AAAA-MM-JJ : \n'));
    const choixDepart = new Date(readlineSync.question('\nRenseignez votre date de départ au format AAAA-MM-JJ : \n'));
