...
function classementParNote(mesLogements) { 
...
function rechercheParDate(mesLogements) {
    ...
    const dateFr1 = readlineSync.question('\nRenseignez une date d\'arrivée au format jj/mm/aaaa : \n')
    const dateFr2 = readlineSync.question('\nRenseignez votre date de départ au format jj/mm/aaaa : \n')

    const dateEn1 = datesFrToEn(dateFr1);
    const dateEn2 = datesFrToEn(dateFr2);

    const choixArrivee = new Date(dateEn1);
    const choixDepart = new Date(dateEn2);
